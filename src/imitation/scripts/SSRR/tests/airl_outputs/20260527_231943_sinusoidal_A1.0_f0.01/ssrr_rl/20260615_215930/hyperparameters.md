...
| Parameter | Value | Notes |
|-----------|-------|-------|
| `min_steps` | `1000` | Shortest snippet length sampled (steps) |
| `max_steps` | `1000` | Longest snippet length sampled (steps) |
| `target_scale` | `1.0` | Scalar multiplied onto the sigmoid target before regression; larger values spread the loss landscape |
