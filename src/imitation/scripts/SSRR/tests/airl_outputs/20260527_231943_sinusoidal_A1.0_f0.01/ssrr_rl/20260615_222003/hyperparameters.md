...
| Parameter | Value | Notes |
|-----------|-------|-------|
| `min_steps` | `10` | Shortest snippet length sampled (steps) |
| `max_steps` | `50` | Longest snippet length sampled (steps) |
| `target_scale` | `50.0` | Scalar multiplied onto the sigmoid target before regression; larger values spread the loss landscape |
